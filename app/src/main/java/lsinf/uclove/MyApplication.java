...
public class MyApplication extends Application {
    ...
    public static ArrayList<User> getMatchingUsers() {
        return matchingUsers;
    }
    public static void setMatchingUsers(ArrayList<User> matchingUsers) {
        MyApplication.matchingUsers = matchingUsers;
    }
